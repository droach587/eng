...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <head>
        ...
        <title>ENG ||| Venture Capital | Expert Network Group, LLC</title>
        <meta name="description" content="ENG helps venture investors discover and create new business models.">
